...
\begin{itemize}
  ...
  \item \codeword{gzip} \emph{compression}. Google suggests the use of \codeword{gzip} for compressing files before transferring over the network. This requires additional CPU time to decompress the results, but reduces the bandwidth needed in most cases. The trade-off is usually worthwhile.
