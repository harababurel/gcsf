...
This is strange. After researching the problem, we find a relevant open issue on this subject\footnote{\url{https://github.com/dsoprea/GDriveFS/issues/195}}. According to user \emph{blitz313}\footnote{\url{https://github.com/blitz313}}, the root cause is one of the dependencies. Manual installation of package \codeword{httplib2-0.10.3} (instead of the required version \codeword{0.8}) seems to solve this problem and we can finally mount the filesystem:
